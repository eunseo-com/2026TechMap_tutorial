...
- 상태: C3 월드 기반 SceneKit → RealityKit 재설계 승인, 구현 시작 전
...
- 다음 시작점: `docs/superpowers/specs/2026-08-10-ch1-reality-escape-design.md`를 검토한 뒤 구현 계획을 작성한다.
- 차단 요소: 없음.
...
| --- | --- | --- | --- | --- |
| 2026-08-10 | Chapter 1 C3 월드·현실 숨기 재설계 | C3 SceneKit 월드에서 나무 뒤로 숨었다가 카메라 회전에 들키면 놀란 돼지 모델·자막으로 반응하고, RealityKit의 실제 메쉬 뒤로 이동하는 흐름을 설계함. 금융·저장·Watch 범위는 제외 | 설계 문서 검토 대기 | 구현 계획 작성 |
